...
wait_time = 2 # how long to wait for response before moving to next trial

#times for fixation, cue, SOA and feedback

v_sync = 0.004508 # monitor refresh time, or v-sync time (sec)

Time_Fixation = 1.5 - v_sync #in sec; subtract the time to match with v-sync

Time_Cue = 0.05 - v_sync

Time_Feedback = 2 - v_sync
...
display_size = (800,600) #the monitor display resolution. if fullscr, then resol should match monitor's
